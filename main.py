...
for DELTA in delta_list:
    for BTest in BTest_list:
        ...
        # BTest = [1]
        mu_N_list = [0.25] # in the unit of t
        ...
        B = KC.Kwant_SSeS(NextNanoName=NName, Masterfilepath=master_file_path, ReferenceData=RefName, W_r=300, WSC=200,
                          ...
                          NumBands=1, Mapping=False, GetConductance=GetConductance,
        ...
        B = KC.Kwant_SSeS(NextNanoName=NName, Masterfilepath=master_file_path, ReferenceData=RefName,  W_r=300, WSC=200,
                          ...
                          ShowDensity=ShowDensity, ShowCurrent=False, GetLDOS=True, Swave=False,
                          FieldDependentGap=False, deltaPairingMatrix="sigma_x", deltaPairingMatrix_sign="+",
                          Phase=np.round(np.arange(0, 50) / 25, 5) * np.pi,
                          SaveNameNote=NName, SeriesR=0, DateT=Date, TimeT=Time, MasterMultiRun=MMR,
                          muN=mu_N_list, DefectAmp=0, DefectNumPer=0, CombineMu=True, CombineTev=False, showBands=False,
                          NumBands=1, Mapping=False, GetConductance=GetConductance,
                          muSC=mu_SC_list, delta=DELTA, delta_real=0.58e-3, VGate_shift=Vg_s, SwpID="Phase",
                          PlotbeforeFigures=1,
                          PlotbeforeFigures_Ana=10).Run_sweep()
        ...
        # B = KC.Kwant_SSeS(NextNanoName=NName, Masterfilepath=master_file_path, ReferenceData=RefName, W_r=82,WSC=161,
        #                   DavidPot=DavidPot, W_g=500, S_g=300, D_2DEG=250, gn=30, L_r=4000, L_s=4000,
        #                   alpha=alphaTest, beta=0,
        #                   V_A=[0], TStrength=[0], TeV_Normal=True,
        #                   AddOrbitEffect=False, AddZeemanField=True, AddRashbaSOI=True, AddDresselhausSOI=True,
        ...
        #                   ShowDensity=ShowDensity, ShowCurrent=False, GetLDOS=True, Swave=False,
        #                   FieldDependentGap=False, deltaPairingMatrix="sigma_x", deltaPairingMatrix_sign="+",
        #                   Phase=np.round(np.arange(0, 500) / 250, 5) * np.pi,
        #                   SaveNameNote=NName, SeriesR=0, DateT=Date, TimeT=Time, MasterMultiRun=MMR,
        #                   muN=mu_N_list, DefectAmp=0, DefectNumPer=0, CombineMu=True, CombineTev=False, showBands=False,
        #                   NumBands=1, Mapping=False, GetConductance=GetConductance,
        #                   muSC=mu_SC_list, delta=DELTA, delta_real=0.58e-3, VGate_shift=Vg_s, SwpID="Phase",
        ...
        #
        #
        # B = KC.Kwant_SSeS(NextNanoName=NName, Masterfilepath=master_file_path, ReferenceData=RefName, W_r=300,
        #                   DavidPot=DavidPot, W_g=500, S_g=300, D_2DEG=250, gn=30, L_r=4000, L_s=4000,
        #                   alpha=alphaTest, beta=0,
        #                   V_A=[0], TStrength=[0], TeV_Normal=True,
        #                   AddOrbitEffect=False, AddZeemanField=True, AddRashbaSOI=True, AddDresselhausSOI=True,

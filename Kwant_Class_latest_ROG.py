...
class Kwant_SSeS():
    ...
    def __init__(self, DavidPot=False, GridFactor=1, W_g=300, S_g=400,
                 ...
                 ShowDensity=False, Swave=False, CombineMu = False, AddOrbitEffect=True,
                 SwpID = "Vg",Digits=5,PlotbeforeFigures = 20):
        # a = 30  # nm # grid point separation
        self.GetReferenceData(ReferenceData)
        self.a = a
...
mu_N_list = [3.5e-3,4e-3,4.5e-3,5e-3]
mu_SC_list = [3.5e-3,4e-3,4.5e-3,5e-3]
# E_excited_list = [0.023,0.024]
E_excited_list = [0.021,0.022,0.023,0.024]
TeV_list = [8.6e-3,8.8e-3,9e-3,9.2e-3,9.4e-3]
PeriBC_list = [0]

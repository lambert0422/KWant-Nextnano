    ...
    for Tev in TeV_list:
        for DELTA in delta_list:
            for Vg_s in VGate_shift_list:
                ...
                B = KC.Kwant_SSeS(NextNanoName=NName, alpha=ALPHA, gn=GN, Masterfilepath=master_file_path,
                                  ReferenceData=RefName, W_r=400,
                                  ...
                                  ProOn=ProximityOn_list, BField=list(np.round(np.arange(0,0.1,0.1/100),5)), a=25,
